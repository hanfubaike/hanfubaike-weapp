        ...
        * * */
        myMakerCluster.ZoomArea = function(maxX,minX,maxY,minY,isMapZoom){
            ...
            if (isMapZoom){
              ...
              tmaxX = wx.getStorageSync('maxX');
              tminX = wx.getStorageSync('minX');
              tmaxY = wx.getStorageSync('maxY');
              tminY = wx.getStorageSync('minY');
        ...
        myMakerCluster.OptZoomVariable = function(maxX,minX,maxY,minY){
            ...
            wx.setStorageSync('maxX',tmaxX);
            wx.setStorageSync('minX',tminX);
            wx.setStorageSync('maxY',tmaxY);
            wx.setStorageSync('minY',tminY);
        }
